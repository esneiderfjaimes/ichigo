...
import androidx.compose.ui.unit.dp
import com.red.code015.ui.components.*
...
fun ModalBottomSheetLayout(
    ...
    // remove the top and bottom margin to avoid errors with the calculation of the height
    val layoutDirection = LocalLayoutDirection.current
    val newPadding = PaddingValues(sheetPadding.calculateStartPadding(layoutDirection), 0.dp,
        sheetPadding.calculateEndPadding(layoutDirection), 0.dp)

    BoxWithConstraints(Modifier.padding(newPadding)) {
            ...
            })
        {
            ...
            // Simulate a bottom margin
            Spacer(modifier = Modifier.height(sheetPadding.calculateBottomPadding()))
        }
    }
}
...
private fun Scrim(
    ...
    if (color.isSpecified) {
        ...
        val closeSheet = getString2(Strings.CloseSheet)
